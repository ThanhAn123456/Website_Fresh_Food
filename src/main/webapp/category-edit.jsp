...
<body>
	...
	<div class="container">
		...
		<form action="updateCategory" method="post">
			<h2 style="display: flex; justify-content: center; padding: 15px 0px 0px 0px;">Sửa danh mục</h2>
			<div class="row">
				<div class="c-8">
					<div class="row margin-top-64">
						<div class="c-12">
							<div class="row">
								...
								<div class="c-8">
									<input type="text" value="<%= category.getNameCategory() %>" name="nameCategory" id="name"
							...
							<div class="row">
								...
								<div class="c-8">
									<textarea name="describe" id="description" cols="30" rows="10"
										required><%= category.getDescribe() %></textarea>
								</div>
							</div>
						</div>
						<div class="c-o-4 c-8">
