...
<body>
	...
	<div class="container">
		<h2 style="display: flex; justify-content: center; padding: 15px 0px 0px 0px;">Danh sách sản phẩm</h2>
		<p>
		    <a href="./product-insert.jsp" class="btn btn-outline-success">Tạo mới</a>
		</p>
		    ...
		    <thead>
		        ...
		        <tbody>
	        		...
	        		<tr>
	        			...
	        			<td><%= CategoryDAO.getInstance().getCategoryById(product.getIdCategory()).getNameCategory() %></td>
	        			<td style="display: flex;">
				            <a href="./product-edit.jsp?idProduct=<%= product.getIdProduct() %>" class="btn btn-outline-primary" style="display: flex;">Sửa</a>
				            <a href="./product-detail.jsp?idProduct=<%= product.getIdProduct() %>" class="btn btn-outline-info" style="display: flex;">Chi tiết</a>
				            <a href="./product-delete.jsp?idProduct=<%= product.getIdProduct() %>" class="btn btn-outline-danger" style="display: flex;">Xóa</a>
						</td>
	        		</tr>
		        	<%	
		        	}
