...
<body>
	...
	<div class="container">
		...
		<%
		Product product = ProductDAO.getInstance().getProductById(request.getParameter("idProduct"));
		%>
		<form action="updateProduct" method="post"
			enctype="multipart/form-data">
			<h2 style="display: flex; justify-content: center; padding: 15px 0px 0px 0px;">Sửa sản phẩm</h2>
			<div class="row">
				<div class="c-8">
					<div class="row margin-top-64">
						<div class="c-12">
							<div class="row">
								<input type="hidden" value="<%= request.getParameter("idProduct") %>" name="idProduct" id="id"
										class="input-promanager">
								<div class="c-4">
									<label for="name">Tên sản phẩm:</label>
								</div>
								<div class="c-8">
									<input type="text" value="<%= product.getNameProduct() %>" name="nameProduct" id="name"
						...
						<div class="c-12">
							<div class="row">
								...
								<div class="c-8">
									<input type="number" value="<%= product.getQuantity() %>" name="quantity" id="quantity"
										class="input-promanager" required>
								</div>
							</div>
						</div>
						<div class="c-12">
							<div class="row">
								...
								<div class="c-8">
									<input type="number" value="<%= product.getOldPrice() %>" name="oldPrice" id="old-price"
										class="input-promanager" required>
								</div>
							</div>
						</div>
						<div class="c-12">
							<div class="row">
								...
								<div class="c-8">
									<input type="number" value="<%= product.getNewPrice() %>" name="newPrice" id="new-price"
										class="input-promanager" required>
								</div>
							</div>
						</div>
						<div class="c-12">
							<div class="row">
								...
								<div class="c-8">
									<img alt="" src="img/product/<%= product.getImg() %>">
								...
								<div class="c-8">
									<select name="idCategory" id="category" required>
										...
										for (Category category : listCategory) {
											if(category.getIdCategory().equals(product.getIdCategory())){
												out.print("<option value='" + category.getIdCategory() + "' selected>" + category.getNameCategory() + "</option>");
											}else{
							...
							<div class="row">
								...
								<div class="c-8">
									<textarea name="describe" id="description" cols="30" rows="10"
										required><%= product.getDescribe() %></textarea>
								</div>
							</div>
						</div>
						<div class="c-o-4 c-8">
