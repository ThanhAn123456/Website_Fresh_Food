...
<body>
	...
	<div class="container">
		...
		<form action="deleteProduct" method="post"
			...
			<h2 style="display: flex; justify-content: center; padding: 15px 0px 0px 0px;">Xóa sản phẩm</h2>
			<h4 style="padding: 15px 0px 0px 0px; color: red">Bạn có chắc muốn xóa sản phẩm?</h4>
			<div class="row">
				<div class="c-8">
					<div class="row margin-top-64">
						<div class="c-12">
							<div class="row">
								...
								<div class="c-8">
									<label><%= request.getParameter("idProduct") %></label>
								</div>
							</div>
						</div>
						<div class="c-12">
							<div class="row">
								...
								<div class="c-8">
									<label><%= product.getNameProduct() %></label>
								</div>
							</div>
						</div>
						<div class="c-12">
						...
						<div class="c-12">
							<div class="row">
								...
								<div class="c-8">
									<label><%= product.getOldPrice() %></label>
								</div>
							</div>
						</div>
						<div class="c-12">
							<div class="row">
								...
								<div class="c-8">
									<label><%= product.getNewPrice() %></label>
								</div>
							</div>
						</div>
						<div class="c-12">
						...
						<div class="c-12">
							<div class="row">
								...
								<div class="c-8">
									<label><%= CategoryDAO.getInstance().getCategoryById(product.getIdCategory()).getNameCategory() %></label>
								</div>
							</div>
						</div>
						<div class="c-12">
							<div class="row">
								...
								<div class="c-8">
									<label><%= product.getDescribe() %></label>
								</div>
							</div>
						</div>
						<div class="c-o-4 c-8">
							<input type="submit" class="input-promanager input-promanager-delete"
								value="Xóa sản phẩm">
						</div>
					</div>
				</div>
