...
<body>
				...
				<div class="col-lg-7">
					<nav class="header__menu">
						<ul>
							...
							<li class="active"><a href="./category-management.jsp">Danh mục</a></li>
	...
	<div class="container">
		<h2 style="display: flex; justify-content: center; padding: 15px 0px 0px 0px;">Danh sách danh mục</h2>
		<p>
		    <a href="./category-insert.jsp" class="btn btn-outline-success">Tạo mới</a>
		</p>
		        ...
		        <tbody>
	        		...
	        		<tr>
	        			...
	        			<td style="display: flex;">
				            <a href="./category-edit.jsp?idCategory=<%= category.getIdCategory() %>" class="btn btn-outline-primary" style="display: flex;">Sửa</a>
				            <a href="./category-delete.jsp?idCategory=<%= category.getIdCategory() %>" class="btn btn-outline-danger" style="display: flex;">Xóa</a>
						</td>
	        		</tr>
		        	<%	
		        	}
