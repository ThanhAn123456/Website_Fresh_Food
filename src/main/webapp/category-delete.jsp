...
<body>
	...
	<div class="container">
		...
		<%
		Category category = CategoryDAO.getInstance().getCategoryById(request.getParameter("idCategory"));
		%>
		<form action="deleteCategory" method="post">
			<h2 style="display: flex; justify-content: center; padding: 15px 0px 0px 0px;">Xóa danh mục</h2>
			<div class="row">
				<div class="c-8">
					<div class="row margin-top-64">
						<div class="c-12">
							<div class="row">
								<input type="hidden" value="<%= request.getParameter("idCategory") %>" name="idCategory" id="id"
										class="input-promanager">
								<div class="c-4">
									<label>Id danh mục:</label>
								</div>
								<div class="c-8">
									<label><%= request.getParameter("idCategory") %></label>
								</div>
							</div>
						</div>
						<div class="c-12">
							<div class="row">
								...
								<div class="c-8">
									<label><%= category.getNameCategory() %></label>
								</div>
							</div>
						</div>
						<div class="c-12">
							<div class="row">
								...
								<div class="c-8">
									<label><%= category.getDescribe() %></label>
								</div>
							</div>
						</div>
						<div class="c-o-4 c-8">
