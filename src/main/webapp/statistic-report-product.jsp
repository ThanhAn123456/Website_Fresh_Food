...
<body>
	...
	<!-- statistic-report-product Section Begin -->
	<div class="container">
		<form action="reportProduct" method="post">
			<div class="c-12" style="margin:15px 0px 15px 0px">
				<div class="row">
					<div class="c-4">
			...
			<div class="c-12" style="margin:15px 0px 15px 0px">
				<div class="row">
					<p style="margin:0px 15px 0px 0px">
					    <a class="btn btn-outline-primary">Lọc</a>
					</p>
					<div>
		    ...
		    <thead>
		        ...
		        <tbody>
		        	...
		        	for(Product product:products){
		        		if(listCategory.get(0).getIdCategory().equals(product.getIdCategory())){
			        	%>
		        		<tr>
	...
	<!-- statistic-report-product Section End -->
	...
	<script>
	    ...
	    // Lấy nút Lọc
	    var filterButton = document.querySelector(".btn-outline-primary");
	 	// Khi nút Lọc được click
	    filterButton.addEventListener("click", function(event) {
	    	var categoryId = document.getElementById("category").value;
	        // Xóa bỏ các hàng đã có trong tbody
	        tbody.innerHTML = "";
	        <%
	        for (Product product:products){
	        %>
	        	if(categoryId === "<%= product.getIdCategory() %>" ){
